...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Bien bien5 = new Maison("adr", Wilaya.WILAYA2, 160, prop3, Transaction.LOCATION, 150000., true, "desc", LocalDateTime.now(), false, 10, true, 2, false, false, true, 120);
        Bien bien6 = new Appartement("adr", Wilaya.WILAYA3, 50, prop2, Transaction.LOCATION, 60000., false, "desc", LocalDateTime.now(), false, 1, true, 6, false, false);
        Bien bien7 = new Terrain("adr", Wilaya.WILAYA1, Wilaya.WILAYA1, 650, prop1, Transaction.ECHANGE, 18000000., true, "desc", LocalDateTime.now(), false, "stat", 1);
        Bien bien8 = new Maison("adr", Wilaya.WILAYA2, Wilaya.WILAYA2, 200, prop2, Transaction.ECHANGE, 14000000., false, "desc", LocalDateTime.now(), false, 11, false, 3, true, false, false, 160);
